...
class LevelCreator():
    ...
    def start(self):
        ...
        self._covered_time = self._start_time
...
Start playing the song, return to this terminal, and begin pressing
 Q, W, E, and R on the beats you want the arrows to strike.
When you're done, press 's' to stop.
